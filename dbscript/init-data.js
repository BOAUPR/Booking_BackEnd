...
async function main () {
  ...
  const Approver3 = new Approver({ user: approver1, booking: event2 })
  const Approver4 = new Approver({ user: approver2, booking: event2 })
  ...
  InstitutionIF.users.push(localadmin1)
  ...
  const localadmin2 = new User({ username: 'localadmin2@mail.com', password: 'password', name: 'Piyathida', surname: 'Plaiifah', roles: [ROLE.LOCAL_ADMIN], institution: InstitutionMS })
  ...
  const Approver5 = new Approver({ user: approver3, booking: event3 })
  const Approver6 = new Approver({ user: approver4, booking: event3 })
  ...
  InstitutionMS.users.push(localadmin2)
  ...
  event3.approveres.push(Approver5)
  event3.approveres.push(Approver6)
  BuildingMS.save()
  await event3.save()
  await room103.save()
  await room107.save()

...
async function main () {
  ...
  const ApproveUser = new User({ username: 'approver@mail.com', password: 'password', name: 'Jirat', surname: 'Klomkleaw', roles: [ROLE.APPROVER, ROLE.USER], institution: InstitutionIF }, { username: 'approver2@mail.com', password: 'password', name: 'Puchong', surname: 'Sumalanukun', roles: [ROLE.APPROVER, ROLE.USER], institution: InstitutionIF })

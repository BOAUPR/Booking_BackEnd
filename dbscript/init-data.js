...
async function main () {
  ...
  const room3C01 = new Room({ code: 'IF', name: '3C01', capacity: 200, floor: 3, building: BuildingIF, approveres: ApproveUser })
  const room4C01 = new Room({ code: 'IF', name: '4c01', capacity: 150, floor: 4, building: BuildingIF, approveres: ApproveUser })
  const room5C01 = new Room({ code: 'IF', name: '5c01', capacity: 100, floor: 5, building: BuildingIF, approveres: ApproveUser })
